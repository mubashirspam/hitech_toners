...
export default function Quotation() {
    ...
    const handleUpdateItem = useCallback((index: number, updates: Partial<QuotationItem>) => {
    ...
    return (
        <div className="space-y-4 pb-10">
            ...
            <div className="flex items-center gap-4">
                ...
                <Button onClick={() => downloadHtmlAsPdf("quotationContainer", "Quotation")}>Generate Quotation</Button>
            </div>

            <div className="fixed top-0 left-0 -translate-x-[150%] -translate-y-[150%] pointer-events-none">
                <QuotationTemplate id="quotationContainer" {...formState} items={items} />
            </div>
        </div>
    );
}
